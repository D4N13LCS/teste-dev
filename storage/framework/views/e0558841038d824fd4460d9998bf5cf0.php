...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom mb-4">
    ...
    <form class="form-inline ml-auto" action="<?php echo e(url('contatos/search')); ?>" method="GET">
        ...
        <select name="filtro" id="filtro" class="custom-select mr-2">
            ...
            <option value="cep" <?php echo e(request()->input('filtro') == 'cep' ? 'selected' : ''); ?>>cep</option>
            <option value="rua" <?php echo e(request()->input('filtro') == 'rua' ? 'selected' : ''); ?>>rua</option>
            <option value="numero" <?php echo e(request()->input('filtro') == 'numero' ? 'selected' : ''); ?>>numero</option>
            <option value="complemento" <?php echo e(request()->input('filtro') == 'complemento' ? 'selected' : ''); ?>>complemento</option>
            <option value="cidade" <?php echo e(request()->input('filtro') == 'cidade' ? 'selected' : ''); ?>>cidade</option>
            <option value="estado" <?php echo e(request()->input('filtro') == 'estado' ? 'selected' : ''); ?>>estado</option>
        </select>
...
<?php /**PATH /mnt/c/Users/Optx 9010/Desktop/Nova pasta (2)/libre-contacts/resources/views/principal.blade.php ENDPATH**/ ?>